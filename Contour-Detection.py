...
while(True): #Jeden Frame laden
    ...
    try:
        #im = cv2.imread(r'D:\Fotos-Videos\olte pumpereidn\BLOB3.jpg')
        if im.shape[0] > 4000:
    ...
    try:
        if len(Circularity_list) != 0:
            ...
            cv2.putText(frame, "P{}".format(i), (point_list[-1][0] - 20, point_list[-1][1] + 30),
...
cv2.imwrite(r'C:\Users\Martino\PycharmProject\untitled\chosen_pics\frames_Marker_history.jpg', im)
#'''